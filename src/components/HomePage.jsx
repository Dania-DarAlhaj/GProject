...
const navigate = useNavigate();
  ...
  const services = [
    ...
    { title: 'Luxury Cakes', desc: 'Bespoke wedding cakes crafted by master pastry chefs with premium ingredients.', icon: '🍰' },
    { title: 'Floral Design', desc: 'Stunning floral arrangements and sophisticated venue styling by expert designers.', icon: '🌹' },
  ];
